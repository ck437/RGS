...
public class aviewcomplaints extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdaptor = new ArrayAdapter<>(aviewcomplaints.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.complaint_types));
        ...
        Ref.addSnapshotListener(this, new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                ...
                for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                    ...
                    if(complaint.equals(complaintlist)) {
